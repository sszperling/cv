...
\section*{Experiencia Laboral}
    ...
    \cventry{Jun 2016 - Actualidad}{Analista Desarrollador SSr}{Despegar.com}{Buenos Aires}{}{
        \begin{itemize}
            \item Desarrollo de dos aplicaciones con más 250k usuarios diarios
            \item Diseño de arquitectura con en patrones reutilizables para mejor escalabilidad
            \item Monitoreo y mejoramiento de métricas ténicas (Error Rate, ANR, APK size)
            \item Testing de UI automatizado con Robotium y UIAutomator
        \end{itemize}}

    \cventry{Feb 2016 - Jun 2016}{Trainee}{Despegar.com}{Buenos Aires}{}{
        Capacitación con tecnologías de todo el stack: back-end, front-end, QA/Automation}

\section*{Formación}

    \cvitemwithcomment{2014 - Actualidad}{Universidad de Buenos Aires, Lic. en Ciencias de la Computación}{Universidad\\ 4to año}
...
\section*{Conocimientos técnicos}
    ...
    \cvitem{Lenguajes de programación}{Java, C/C++, JavaScript, HTML+CSS, SQL, Smalltalk, PHP}
